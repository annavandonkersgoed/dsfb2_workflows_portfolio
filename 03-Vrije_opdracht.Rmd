...
Zoals te zien zijn er twee verschillende countmatrixen aanwezig in de data. Voor deze analyse werken we verder met de matrix genaamd Gene Expression.
...
De doublets in de dataset werd verwijderd met de R package DoubletFinder. 3 parameters zijn belangrijk in deze package:
...
```{r foldertree,  out.width = "700px", fig.cap="Folder tree cursus dsfb1", echo = FALSE}
...
In dit figuur is te zien dat onder de gekozen stappen eerder in de analyse de optimale pK een waarde heeft van 0.19. 