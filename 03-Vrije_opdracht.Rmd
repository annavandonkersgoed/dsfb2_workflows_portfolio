...
Hier staat een workflow om single cell RNA sequencing data uit te werken. 
...
De eerste stap was om een tutorial te volgen. Dit werd gedaan door dit artikel (source). De data hiervan is niet weergeven. Daarna werd er een tutorial gevolgd (source) waarbij de dataset werd gebruikt van een 27 jarige gezonde man met als sample human peripheral blood mononuclear cells (PBMCs). Dit is een andere dataset dan degene die in de tutorial wordt gebruikt. 
